...
> *The bootstrap distribution is attempting to approximate the mean of the gpp using 1 sample. Compared to the sampling distribution, the standard deviation is incredible- since there is only one value. Although it is replicated just as many times, it only has one sample to replicate therefore the replications are irrelevant. Bootstrapping can be incredibly useful in EaES because*
